...
const (
	...
	HelpText = "" +
		...
		"\n" +
		"Начнём с того, что я слежу за текущим курсом и могу подсказать сколько стоит " +
		"нынче рубль :)\n" +
		...
		"прямые линии)\n\n" +
		"Ещё одна функция обязательно пригодится для настоящих йогов, я могу помочь тебе выучить названия " +
		"многих поз на санскрите\n" +
		"/yoga - выведет фотографию и варианты ответа\n\n" +
		"/weather - показывает текущую погоду, на данный момент метеостанция настроена только в Москве"
	...
	AdminHelpText = "" +
		...
		"/mail # - создать указанный почтовый ящик, без аргумента создаст временный\n"
